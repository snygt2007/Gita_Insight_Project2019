...
def Get_average_score_ranking(df_average_score_list,df_folder_list,df_main_folder_path, query_path,dir_litw_semisuper_clean):
...
def Get_feature_score(intermediate_layer_model,query_path, features_path):
